package com.rair.diary.utils.calendar;
...
import com.rair.diary.utils.calendar.Util;

import java.util.ArrayList;
import java.util.List;
import java.util.TimeZone;

import static com.rair.diary.utils.calendar.Util.checkContextNull;
...
public class CalendarProviderManager {
    ...
    private static String getFullRRuleForRRule(String rRule, long beginTime, long endTime) {
        ...
        switch (rRule) {
            case RRuleConstant.REPEAT_CYCLE_DAILY_FOREVER:
                return builder.append(rRule).toString();
